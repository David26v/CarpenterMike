          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <Card className="backdrop-blur-xl bg-slate-800/80 border-slate-700/50 hover:border-amber-500/50 transition-all duration-500">
              ...
              <CardContent>
                ...
                {error && (
                  <Alert variant="destructive" className="mb-6 bg-red-500/20 border-red-500/50 text-red-400">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <option value="Bathroom Transformation">Bathroom Transformation</option>
                        <option value="Kitchen & Bath Combined">Kitchen & Bath Combined</option>
                        <option value=">Custom Cabinet Systems">Custom Cabinet Systems</option>
                      </select>
                    </div>
                  </div>
