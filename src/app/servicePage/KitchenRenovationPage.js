...
import {
  ...
  kitchenImages,
  beforeAfterImages,
} from "../data/KitcheRenovationData";
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-amber-100">
                ...
                attention. With 30+ years of experience, I handle every detail
            ...
            <div className="relative">
              <img
                src="/images/kitchen_innovation_bg.jpeg"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Quality kitchen renovations with personal attention and expert
              craftsmanship.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              A straightforward process focused on quality work and your
              satisfaction
            </p>
          </div>
      ...
      <section id="gallery" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Before/After Section - Now with clickable cards */}
      ...
      <section
        id="contact"
        className="py-20 bg-gradient-to-r from-amber-600 to-orange-700 text-white"
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-amber-100">
            Let's talk about your kitchen renovation. I offer free consultations
